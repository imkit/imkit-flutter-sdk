...
class IMKitStreamManager {
  late StreamController<List<IMRoom>> _roomsStreamController;
  StreamController<List<IMRoom>> get rooms => _roomsStreamController;
  ...
  _init() {
    _roomsStreamController = StreamController<List<IMRoom>>.broadcast();
  }
